...
%% Particle finding numbers (you will have to adjust these)
...
%% Particle tracking
[vtracks,ntracks,meanlength,rmslength,found] = PredictiveTracker_MHD_2022(inputname,threshold,max_disp,bground_name,minarea,invert,[],framerange);

%vtracks has all the particle tracks and velocities from the images
